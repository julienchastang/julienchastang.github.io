...
#+BEGIN_SRC emacs-lisp
  ...
  (setq
   ...
   `(,@(create-project-configuration
        "jc-notes"
        "../../src/org/"
        "../../publish/julienchastang.github.io/")
     ("jc-static"
      :base-directory "../../src/static/"
      :publishing-directory "../../publish/julienchastang.github.io/static/"
      :base-extension any
      :recursive t
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key
   ...
   (lambda ()
     (interactive)
     (org-babel-load-file "../../src/org/configuration.org")))
