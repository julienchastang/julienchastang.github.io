...
[[file:~/git/julienchastang/src/static/weatherobs/timeseries.svg]]
...
#+NAME: timeseries
#+BEGIN_SRC http
  GET http://api.mesowest.net/v2/stations/timeseries?token=demotoken&stid=E3608&start=201702280013&end=201703010013&obtimezone=local&units=metric&vars=air_temp,dew_point_temperature,wind_speed,wind_direction,sea_level_pressure&output=csv
#+END_SRC
