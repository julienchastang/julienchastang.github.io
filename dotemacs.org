...
ou can find my [[https://github.com/julienchastang/dotemacs][.emacs]] configuration file on github. Checkout both the ~master~  and ~python~ branches.
...
| package               | description                             | anchors            |
|-----------------------+-----------------------------------------+--------------------|
| yasnippet             | Yet another snippet extension for Emacs | [[python][python]] |
| pyvenv                | Python virtual environment interface    | [[python][python]] |
| company               | Modular text completion framework       |                    |
| highlight-indentation | Minor mode to highlight indentation     |                    |
|-----------------------+-----------------------------------------+--------------------|

#+NAME: my-packages-unstable
|---------------+-----------------------------------------+------------------------------|
| package       | description                             | anchors                      |
|---------------+-----------------------------------------+------------------------------|
| ein           | Emacs IPython Notebook                  | [[python][python]]           |
| ob-ipython    | org-babel IPython                       | [[python][python]]           |
...
See [[https://github.com/gregsexton/ob-ipython/issues/60][here]], [[https://github.com/gregsexton/ob-ipython/issues/61][here]]  and  [[file:custom.el][custome.el]] for why ~(elpy-use-ipython)~ is commented out.
